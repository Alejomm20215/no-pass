...
def test_imports():
    ...
    try:
        # Core domain
        from app.core.domain import entities, constants  # noqa: F401

        print("  [OK] Core domain imports OK")

        # Core interfaces
        from app.core.interfaces import pdf_handler  # noqa: F401
        from app.core.interfaces import attack_strategy  # noqa: F401
        from app.core.interfaces import wordlist_provider  # noqa: F401

        print("  [OK] Core interfaces imports OK")

        # Core use cases
        from app.core.use_cases import (  # noqa: F401
            crack_password,
            unlock_pdf,
            batch_process,
        )
        ...
        # Adapters
        from app.adapters.repositories import (  # noqa: F401
            pdf_handler as pdf_impl,
            wordlist_provider as wl_impl,
        )
        from app.adapters.strategies import (  # noqa: F401
            dictionary_attack,
            bruteforce_attack,
            hybrid_attack,
        )
        ...
        # API
        from app.api.v1.routes import health, pdf, crack  # noqa: F401
        from app.api.v1.schemas import (  # noqa: F401
            crack as crack_schema,
            pdf as pdf_schema,
            response,
        )
        ...
        # Config
        from app.config import settings, dependencies  # noqa: F401
...
def test_domain_models():
    ...
    try:
        ...
        options = AttackOptions(mode=AttackMode.DICTIONARY, charset=CharsetType.NUMERIC)
...
def test_api_creation():
    ...
    try:
        ...
        print("  [OK] All key routes present")
