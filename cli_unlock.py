...
def main():
    ...
    parser.add_argument("-o", "--output", help="Path to the output PDF file (default adds _unlocked.pdf)", default=None)
    ...
    out = Path(args.output) if args.output else inp.with_name(inp.stem + "_unlocked.pdf")
