...
class BatchProcessUseCase:
    ...
    def execute(
        ...
        for pdf_file in pdf_files:
            ...
            crack_result = self.crack_use_case.execute(pdf_file, options, file_progress)
            ...
            if auto_unlock:
                ...
                # crack_result.password should be non-None on success, safe to cast via str()
                unlock_result = self.unlock_use_case.execute(
                    pdf_file, str(crack_result.password), output_path
                )
